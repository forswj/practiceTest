...
def login():
    ...
    #driver.get('http://account.saas.weimobqa.com/codeLogin')
    # 最大化浏览器
    driver.maximize_window()
    # 输入账号
    driver.find_element_by_xpath('//*[@id="LoginName"]').send_keys('18068774252')
    # 输入密码
    driver.find_element_by_xpath('//*[@id="Password"]').send_keys('swjswj917')
    # 点击登录
